...
//  Refraktions
//
//  Created by Jason Snell on 11/6/16.
...
public class LinkWrapper:NSObject {
    ...
    fileprivate let QUANTUM_DEFAULT:Float64 = 8
    ...
    fileprivate func getIsPlaying() -> Bool {
    ...
    fileprivate func set(isPlaying:Bool){
    ...
    fileprivate func getBpm() -> Float64 {
    ...
    fileprivate func getBeat() -> Float64 {
    ...
    fileprivate func getPhase() -> Float64 {
    ...
    fileprivate func getQuantum() -> Float64 {
    ...
    fileprivate func setQuantum(quantum:Float64) {
    ...
    fileprivate func getLinkRef() -> ABLLinkRef? {
